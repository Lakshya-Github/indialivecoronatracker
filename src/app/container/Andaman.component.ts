...
@Component({
  ...
  template: `
    ...
    <div class="scroll" style="">
      <h2>If you are not able to see full Table then
Scroll the Table to view more details...</h2>
    </div>
...
export class AndamanComponent implements OnInit {
  data;
  states;
  districts;
