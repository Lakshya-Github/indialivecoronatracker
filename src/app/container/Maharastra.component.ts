...
@Component({
  ...
  template: `
    ...
    <div class="scroll">
      <h2>
        If you are not able to see full Table then <br />
        Scroll the Table to view more details...
      </h2>
    </div>
...
export class MahastraComponent implements OnInit {
  data;
  states;
  districts;
