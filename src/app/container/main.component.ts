...
@Component({
  ...
  template: `
    ...
    <div class="scroll">
      <h2>
        If you are not able to see full Table then
        Scroll the Table to view more details...<br />
        Click on the state to get their cities
      </h2>
    </div>
      ...
      <div style="width: 100%;" class="table-div">
        <table class="table table-bordered table-striped" style="width: 100%;">
          ...
          <tr *ngFor="let item of array">
            <td>
              <a [href]="item.loc">{{ item.loc | truncate }}</a>
            </td>
  ...
  styles: [
    `
      ...
      tr:hover td a {
        /* background: rgba(18, 56, 224, 0.52); */
        color: white;
      }
      tr,
      th,
